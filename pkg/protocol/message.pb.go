...
type Message struct {
	...
	FromUsername string `protobuf:"bytes,2,opt,name=from_username,json=fromUsername,proto3" json:"from_username,omitempty"` // 发送消息用户的用户名
	From         int64  `protobuf:"varint,3,opt,name=from,proto3" json:"from,omitempty"`                                    // 发送消息用户uuid
	To           int64  `protobuf:"varint,4,opt,name=to,proto3" json:"to,omitempty"`                                        // 发送给对端用户的uuid
...
var file_pkg_protocol_message_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x22, 0xa5, 0x02, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x12, 0x23, 0x0a, 0x0d, 0x66, 0x72,
	0x6f, 0x6d, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x02, 0x74, 0x6f, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x05,
	...
	0x74, 0x79, 0x70, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x6d, 0x65, 0x73, 0x73,
